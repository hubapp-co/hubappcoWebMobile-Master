package in.co.hubapp.fileupload;
...
public class FileStorageService {
    ...
    public FileStorageService(FileStorageProperties fileStorageProperties) {
    	System.out.println( this.fileStorageLocation = Paths.get(fileStorageProperties.getUploadDir())
    ...
    public String storeFile(MultipartFile file) {
        ...
        try {
            ...
            docDetails.setFilePath(targetLocation.toString());
            
            Document doc = new Document();
            doc.setFileName(docDetails.getFileName());
            doc.setFilePath(docDetails.getFilePath());
            
            documentRepositoryMob.save(doc);
